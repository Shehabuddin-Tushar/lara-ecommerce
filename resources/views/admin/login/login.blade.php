                        ...
                        {!! Form::open(['url'=>'/login','method'=>'POST']) !!}
                            <fieldset>
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                   ...
                                   {{Form::email('email',$value=null,['class'=>'form-control','placeholder'=>'enter your email','id'=>'email'])}}
                                    @if ($errors->has('email'))
                                ...
                                <!-- Change this to a button or input when using this as a form -->
                                 <div class="form-group">
                                    {{Form::submit('Log In',['class'=>'btn btn-success btn-block','name'=>'submit'])}}
