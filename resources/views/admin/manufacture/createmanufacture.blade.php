...
<div class="row">
 ...
 <div class="col-lg-12">
  ...
  <div class="well">
    ...
    {!! Form::open(['url'=>'/manufacture/save','class'=>'form-horizontal','method'=>'POST'])!!}
       ...
       <div class="form-group">
          ...
          <div class="col-sm-10">
          	<input type="text" class="form-control" id="manufacture" name="manufacturename"/>
  	   ...
  	   <div class="form-group">
          <label for=""manufacture" class="col-sm-2 control-label">manufacture description</label>
          <div class="col-sm-10">
           <textarea class="form-control mceEditor" rows="8" name="manufacturedescription"></textarea>
