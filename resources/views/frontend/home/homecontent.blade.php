			...
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				...
				<div class="resp-tabs-container">
                    ...
                    @foreach($latestproducts as $latestproduct)
							...
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($latestproduct->productimage)}}" alt="" class="pro-image-front">
									<img src="{{asset($latestproduct->productimage)}}" alt="" class="pro-image-back">
								...
								<div class="item-info-product ">
									<h4><a href="{{url('/product-details')}}">{{$latestproduct->productname}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">${{$latestproduct->productprice}}</span>
										
									</div>
                                    {!! Form::open(['url'=>'/cart-add','method'=>'POST'])!!}

                                    <input type="hidden" name="productid" value="{{$latestproduct->id}}"/>
                    ...
                    @foreach($specialproducts as $specialproduct)
							...
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($specialproduct->productimage)}}" alt="" class="pro-image-front">
									<img src="{{asset($specialproduct->productimage)}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
								...
								<div class="item-info-product ">
									<h4><a href="{{url('/product-details')}}">{{$specialproduct->productname}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">${{$specialproduct->productprice}}</span>
                    ...
                    @foreach($collectionproducts as $collectionproduct)
						  ...
						  <div class="col-md-3 product-men yes-marg">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset($collectionproduct->productimage)}}" alt="" class="pro-image-front">
									<img src="{{asset($collectionproduct->productimage)}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
								...
								<div class="item-info-product ">
									<h4><a href="{{url('/product-details')}}">{{$collectionproduct->productname}}</a></h4>
									<div class="info-product-price">
										<span class="item_price">${{$collectionproduct->productprice}}</span>
